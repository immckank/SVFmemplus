...
static const ei_pair ei_pairs[]=
{
    ...
    {"strdup", SaberCheckerAPI::CK_ALLOC},
    {"strndup", SaberCheckerAPI::CK_ALLOC},
    {"realpath", SaberCheckerAPI::CK_ALLOC},
    ...
    {"SoftBusMalloc", SaberCheckerAPI::CK_ALLOC},
    {"SoftBusCalloc", SaberCheckerAPI::CK_ALLOC},
    {"SysMalloc", SaberCheckerAPI::CK_ALLOC},
    {"SysCalloc", SaberCheckerAPI::CK_ALLOC},
    {"FillpMemAlloc", SaberCheckerAPI::CK_ALLOC},
    {"FillpMemCalloc", SaberCheckerAPI::CK_ALLOC},
    {"fs_malloc", SaberCheckerAPI::CK_ALLOC},
    {"fs_zmalloc", SaberCheckerAPI::CK_ALLOC},
    {"hmfs_zmalloc", SaberCheckerAPI::CK_ALLOC},
    {"vfs_file_alloc", SaberCheckerAPI::CK_ALLOC},
    {"OhosMalloc", SaberCheckerAPI::CK_ALLOC},
    {"LOS_MemAlloc", SaberCheckerAPI::CK_ALLOC},
    {"LOS_MemAllocAlign", SaberCheckerAPI::CK_ALLOC},
    {"LOS_MemRealloc", SaberCheckerAPI::CK_ALLOC},
    {"kmalloc", SaberCheckerAPI::CK_ALLOC},
    {"kzalloc", SaberCheckerAPI::CK_ALLOC},
    {"kcalloc", SaberCheckerAPI::CK_ALLOC},
    {"krealloc", SaberCheckerAPI::CK_ALLOC},
    {"kmalloc_array", SaberCheckerAPI::CK_ALLOC},
    {"kvcalloc", SaberCheckerAPI::CK_ALLOC},
    {"kvmalloc", SaberCheckerAPI::CK_ALLOC},
    {"kvmalloc_array", SaberCheckerAPI::CK_ALLOC},
    {"kvzalloc", SaberCheckerAPI::CK_ALLOC},
    {"vmalloc", SaberCheckerAPI::CK_ALLOC},
    {"vzalloc", SaberCheckerAPI::CK_ALLOC},
    {"kmem_cache_alloc", SaberCheckerAPI::CK_ALLOC},
    ...
    {"kmemdup", SaberCheckerAPI::CK_ALLOC},
    {"kmemdup_nul", SaberCheckerAPI::CK_ALLOC},
    ...
    {"cdfs_vfree", SaberCheckerAPI::CK_FREE},
    {"free", SaberCheckerAPI::CK_FREE},
    {"fs_free", SaberCheckerAPI::CK_FREE},
    {"hmfs_free", SaberCheckerAPI::CK_FREE},
    {"hmfs_io_free", SaberCheckerAPI::CK_FREE},
    {"mcache_extent_tree_free", SaberCheckerAPI::CK_FREE},
    {"vfs_file_free", SaberCheckerAPI::CK_FREE},
    ...
    {"SoftBusFree", SaberCheckerAPI::CK_FREE},
    {"SysFree", SaberCheckerAPI::CK_FREE},
    {"FillpMemFree", SaberCheckerAPI::CK_FREE},
    {"RpcFreeBuffer", SaberCheckerAPI::CK_FREE},
    {"OhosFree", SaberCheckerAPI::CK_FREE},
    {"LOS_MemFree", SaberCheckerAPI::CK_FREE},
    {"kmem_cache_free", SaberCheckerAPI::CK_FREE},
    ...
    {"kfree_sensitive", SaberCheckerAPI::CK_FREE},
    {"kfree_rcu", SaberCheckerAPI::CK_FREE},
    {"kfree_call_rcu", SaberCheckerAPI::CK_FREE},
    {"bitmap_free", SaberCheckerAPI::CK_FREE},
    {"devm_kfree", SaberCheckerAPI::CK_FREE},
