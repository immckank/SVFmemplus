 ...
 */
void traverseOnICFG(ICFG* icfg, const ICFGNode* iNode, const ICFGNode* targetNode)
{
    // 调用栈
...
int main(int argc, char ** argv) {
    ...
    if (targetNode) {
        ...
        traverseOnICFG(icfg, startNode, targetNode);
    }
